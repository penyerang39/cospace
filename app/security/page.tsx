            ...
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:h-[60vh] overflow-hidden rounded-lg bg-foreground/2">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted">Encryption Visualization</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:h-[60vh] overflow-hidden rounded-lg bg-foreground/2">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted">Access Control Dashboard</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-width container-padding grid md:grid-cols-2 items-center gap-8 w-full">
          <div className="order-1">
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:h-[60vh] overflow-hidden rounded-lg bg-foreground/2">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <FileCheck className="w-16 h-16 text-accent mx-auto mb-4" />
                  <p className="text-muted">Audit Logs Interface</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:h-[60vh] overflow-hidden rounded-lg bg-foreground/2">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted">Global Infrastructure Map</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:h-[60vh] overflow-hidden rounded-lg bg-foreground/2">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted">Security Monitoring Dashboard</p>
                </div>
              </div>
            </div>
          </div>
